/*
 * $RCSfile: SRCPProcessorDiedException.java,v $
 *
 * History
...
public class SRCPProcessorDiedException extends SRCPServerException {

    public SRCPProcessorDiedException () {
        super(600,"processor died");
    }

    public SRCPException cloneExc() {
    	return new SRCPProcessorDiedException ();
    }
