/*
 * $RCSfile: SRCPListToLongException.java,v $
 *
 * History
...
public class SRCPListToLongException extends SRCPCommandException {

    public final static int NUMBER = 418;
    
    public SRCPListToLongException () {
        super(NUMBER,"list to long");
    }

    public SRCPListToLongException (Throwable cause) {
        super(NUMBER,"list to long", cause);
    }
    public SRCPException cloneExc () {
    	return new SRCPListToLongException();
    }
}
